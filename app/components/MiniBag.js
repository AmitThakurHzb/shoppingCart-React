...
var MinibagPanel = React.createClass({
	componentDidMount : function(){
			//alert(this.props.itemObj.count);
			console.log(this.props.itemObj.count+" loaded");
	},
	render:function(){
...
var MiniBag = React.createClass({
    ...
    render: function(){
      ...
      //return (<ul>{items}</ul>);
      return <MinibagPanel countObj={{count:0,price:0}} />
...
/*<div class="dropdown">
                <a class="cart__link" href="#">
                    <div class="cart-count ">
                        Bag <span class="cart-count__price">42.00</span>
                        <span class="cart-count__value">(12)</span>
                    </div>
                </a>
                <div class="dropdown-menu " role="menu" aria-labelledby="dLabel ">
                        <section id="minibag-contents">
                                     <form id="" action="" class="cart-form">
                                        <ul class="cart-item">
                                            <li class="cart-item__img">
                                                <a href="#">
                                                    <img src="data:image/jpeg;base64," alt="" >
                                                </a>
                                            </li>
                                        ...
                                        <a href="#" class="minibag-remove icon-closesmall" data-toggle="tooltip" data-original-title="Remove"></a>                                  
                                </form>
                        </section>
                        <section class="cart-subTotal">
                            <p class="cart-cartSubtotal">Subtotal <strong>€89.00</strong></p>                  
                        </section><br />
                        <footer>
                        <button class="btn btn-primary btn-sm">View Bag</button></footer>
                    </div>
                </div>
            </div>*/